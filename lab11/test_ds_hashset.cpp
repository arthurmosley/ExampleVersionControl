...
int main() {
  ...
  insert_result = set1.insert( std::string("cat") );
  assert( insert_result.second );

  insert_result = set1.insert( std::string("tac") );
  assert( insert_result.second );
...
std::cout << "\n\n  ///////////////////////////////////////////////////* CHECK 2 PART 2 */////////////////////////////////////////////////////" << std::endl;
  ...
  assert( insert_result.second );
  insert_result = set1.insert( std::string("gnimmiws") );
  assert( insert_result.second );
